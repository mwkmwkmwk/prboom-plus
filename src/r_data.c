...
static void R_InitColormaps(void)
{
  ...
  colormap_doomdev_fd = Z_Malloc(sizeof(*colormap_doomdev_fd) * numcolormaps, PU_STATIC, 0);
  colormap_doomdev_idx = Z_Malloc(sizeof(*colormap_doomdev_idx) * numcolormaps, PU_STATIC, 0);
